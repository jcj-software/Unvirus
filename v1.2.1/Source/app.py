...
openFile = Button(ButtonFrame1, text = lang_load.lang_OpenFile, command = openFileFunc, style = "Outline.TButton")
openFile.pack(side = "left", padx = 25)
checkFile = Button(ButtonFrame1, text = lang_load.lang_CheckFile, command = checkFileFunc, style = "Outline.TButton")
